...
pub mod module {
    ...
    pub type LiquidationIncentive<T: Config> =
        StorageMap<_, Twox64Concat, CurrencyId, FixedU128, ValueQuery>;
    ...
    pub struct GenesisConfig {
        ...
        pub liquidation_incentive: Vec<(CurrencyId, FixedU128)>,
        pub liquidation_threshold: Vec<(CurrencyId, FixedU128)>,
