...
fn init_minting_ok() {
    ExtBuilder::default().build().execute_with(|| {
        // assert_eq!(Assets::balance(DOT, ALICE), 100);
        // assert_eq!(Assets::balance(USDT, ALICE), 100);
        // assert_eq!(Assets::balance(DOT, BOB), 100);
        // assert_eq!(Assets::balance(USDT, BOB), 100);
    });
}
