...
benchmarks! {
    ...
    cancel_stream {
        ...
        let start_time: u64 = 6;
        let end_time: u64 = 18;
        assert_ok!(Streaming::<T>::create_stream(SystemOrigin::Signed(caller.clone()).into(), recipient.clone(), deposit_amount, KSM, start_time, end_time));
    ...
    withdraw_from_stream {
        ...
        let start_time: u64 = 6;
        let end_time: u64 = 18;
        assert_ok!(Streaming::<T>::create_stream(SystemOrigin::Signed(caller).into(), recipient.clone(), deposit_amount, KSM, start_time, end_time));
