...
pub mod pallet {
	...
	impl<T: Config> primitives::xcm_unit::AssetTypeGetter<T::AssetId, T::AssetType> for Pallet<T> {
	...
	impl<T: Config> primitives::xcm_unit::UnitsToWeightRatio<T::AssetType> for Pallet<T> {
