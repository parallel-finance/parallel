...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {	fn create() -> Weight {
		...
		(34_000_000 as Weight)			.saturating_add(T::DbWeight::get().reads(3 as Weight))			.saturating_add(T::DbWeight::get().writes(2 as Weight))	}	fn claim() -> Weight {
...
impl WeightInfo for () {	fn create() -> Weight {
		...
		(34_000_000 as Weight)			.saturating_add(RocksDbWeight::get().reads(3 as Weight))			.saturating_add(RocksDbWeight::get().writes(2 as Weight))	}	fn claim() -> Weight {
