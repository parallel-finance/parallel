...
benchmarks_instance_pallet! {
    ...
    verify {
        assert_last_event::<T, I>(Event::LiquidityAdded(caller, BASE_ASSET, QUOTE_ASSET, 0u128, 0u128).into());
    }
    ...
    verify {
        assert_last_event::<T, I>(Event::LiquidityRemoved(caller, BASE_ASSET, QUOTE_ASSET, 0u128).into());
    }
