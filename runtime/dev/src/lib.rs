...
use frame_support::{
    ...
    traits::{
        ...
        Everything, FindAuthor, InstanceFilter, KeyOwnerProofSystem, Nothing, OnUnbalanced,
    },
    weights::{
...
use sp_runtime::{
    ...
    traits::{
        ...
        BlockNumberProvider, Convert, DispatchInfoOf, Dispatchable, NumberFor, PostDispatchInfoOf,
...
impl pallet_liquid_staking::Config for Runtime {
    ...
    type RelayChainValidationDataProvider = MockRelayChainProvider;
    type Loans = Loans;
...
parameter_types! {
    ...
    pub VanillaNetwork: NetworkId = NetworkId::Named(WeakBoundedVec::<u8, ConstU32<32>>::force_from("vanilla".into(), None));
...
pub struct MockRelayChainProvider;

impl BlockNumberProvider for MockRelayChainProvider {
...
impl ValidationDataProvider for MockRelayChainProvider {
...
impl pallet_crowdloans::Config for Runtime {
    ...
    type WeightInfo = ();
    type XCM = XcmHelper;
    type RelayChainBlockNumberProvider = MockRelayChainProvider;
