...
impl<T: frame_system::Config> pallet_liquid_staking::WeightInfo for WeightInfo<T> {
	...
	fn fast_match_unstake(n: u32, ) -> Weight {
		(60_550_000 as Weight)
			...
			.saturating_add((130_050_000 as Weight).saturating_mul(n as Weight))
