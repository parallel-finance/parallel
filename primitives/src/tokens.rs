...
pub const PCKSM_SUB: CurrencyId = 3100;
pub const PCKSM_KSX: CurrencyId = 3101;
pub const PCKSM_SKU: CurrencyId = 3102;

// Crowdloans Derivative
pub const CKSM_SUB: CurrencyId = 4000;
pub const CKSM_KSX: CurrencyId = 4001;
pub const CKSM_SKU: CurrencyId = 4002;
