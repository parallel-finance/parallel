...
pub type ParachainBlockImport<RuntimeApi, Executor> = TParachainBlockImport<
    Block,
    FrontierBlockImport<
        Block,
    ...
    Executor: NativeExecutionDispatch + 'static,
{
    ...
    let (mut telemetry, telemetry_worker_handle, frontier_backend, parachain_block_import) =
        params.other;
