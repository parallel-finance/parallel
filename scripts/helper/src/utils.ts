...
export const getDefaultRelayChainWsUrl = ():string => {
  return process.env['RELAY_CHAIN_TYPE']==='kusama'?'wss://kusama-rpc.polkadot.io':'wss://rpc.polkadot.io'
}

export const getDefaultParachainWsUrl = ():string => {
  return process.env['RELAY_CHAIN_TYPE']==='kusama'?'wss://heiko-rpc.parallel.fi':'wss://rpc.parallel.fi'
}
